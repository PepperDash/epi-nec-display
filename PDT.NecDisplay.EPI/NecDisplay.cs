...
namespace PDT.NecDisplay.EPI
{
	...
	public class PdtNecDisplay : TwoWayDisplayBase, IBasicVolumeWithFeedback, ICommunicationMonitor, IBridgeAdvanced
	{
        ...
        public const string Hdmi1Cmd = "\x01\x30\x2A\x30\x45\x30\x41\x02\x30\x30\x36\x30\x30\x30\x31\x31\x03"; //\x72\x0d
        public const string Hdmi2Cmd = "\x01\x30\x2A\x30\x45\x30\x41\x02\x30\x30\x36\x30\x30\x30\x31\x32\x03"; //\x71\x0D
        public const string Hdmi3Cmd = "\x01\x30\x2A\x30\x45\x30\x41\x02\x30\x30\x36\x30\x30\x30\x38\x32\x03"; //\x78\x0D
        public const string Hdmi4Cmd = "\x01\x30\x2A\x30\x45\x30\x41\x02\x30\x30\x36\x30\x30\x30\x38\x33\x03"; //\x79\x0D
